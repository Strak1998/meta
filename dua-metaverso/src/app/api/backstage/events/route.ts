...
const VALID: CommandType[] = [
  "PHASE_CHANGE","ARTIST_ENTER","ARTIST_EXIT","ARTIST_INTRO","ARTIST_ANIMATION","SPOTLIGHT","AUDIO_SOURCE","AUDIO_COMMAND",
  "CHAT_HIGHLIGHT","CHAT_BROADCAST","CHAT_REMOVE","CTA_TRIGGER","OVERLAY_SHOW","OVERLAY_HIDE",
  "CONFETTI","EMERGENCY_PAUSE","EMERGENCY_RESUME","EMERGENCY_MESSAGE",
];
